...
require([
    ...
    //Multipoint Layer expires 7/30/18
    const responseMultiPoints = new FeatureLayer("https://services9.arcgis.com/YAP3K4uZesDpycxm/arcgis/rest/services/Multipoint/FeatureServer/0", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ['*']
    });
